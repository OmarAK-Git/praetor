...
|---|---|---|---|---|---|---|
| VERIFY-001 | REQ-001 | Codification unit tests | `python -m pytest -q tests/codification/test_sweep.py` | 5 pass | 5 passed | pass |
...
| VERIFY-004 | all | Full suite | `python -m pytest -q` | pass | 749 passed, 2 deselected, 1 xfailed | pass |
| VERIFY-005 | all | Static analysis | `python -m mypy src evals consumer_sdk` | clean | 116 files clean | pass |
