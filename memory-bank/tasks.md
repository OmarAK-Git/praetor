...
**Next up:** V2-008 (Gate 1); branch `task/V2-007` at `.worktrees/V2-007`.
...
| V2-007 | ProviderUnavailable Intake Handling | `.workflow/V2-007/verification.md` — breaker + metrics on intake; scoped pytest 161; `task/V2-007` |
