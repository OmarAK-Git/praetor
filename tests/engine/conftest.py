"""Fixtures for walking skeleton engine tests."""
...
@pytest.fixture
def stamp_backend() -> SucceedingStampBackend:
    return SucceedingStampBackend()


@pytest.fixture
def judgment_provider() -> _CountingJudgmentProvider:
    return _CountingJudgmentProvider(judgment=skeleton_model_judgment())
